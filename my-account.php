...
if (isset($_POST['update_profile'])) {
    ...
    if (empty($name) || empty($email)) { $error_message = 'El nombre y el email son obligatorios.'; }
        ...
        if($stmt->execute()){ $success_message = "Perfil actualizado con éxito."; }
...
<main class="container my-5 flex-shrink-0">
    ...
    <div class="row g-4">
        <div class="col-lg-6">
            <div class="card h-100"><div class="card-header"><h4>Mis Datos</h4></div><div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card h-100"><div class="card-header"><h4>Cambiar Contraseña</h4></div><div class="card-body">
                <form action="my-account.php" method="POST">
        ...
        <div class="col-12">
            <div class="card mt-4"><div class="card-header"><h4>Mi Historial de Descargas</h4></div><div class="card-body">
                ...
                <?php else: ?>
                    ...
                    <?php foreach($download_history as $item): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="text-muted">Descargado el: <?php echo date('d/m/Y', strtotime($item['downloaded_at'])); ?></span>
                        </li>
                    <?php endforeach; ?>
                    </ul>
                <?php endif; ?>
...
<script>
    // Pequeño script para separar y pre-rellenar el número de whatsapp
